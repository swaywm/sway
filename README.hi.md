...
*	dnf - रेड हेट (Red Hat) बेस वाले लिनक्स डिस्ट्रो जैसें - फेडोरा (Fedora), RHEL  इत्यादि में निम्नानुसार कमांड को टर्मिनल मे लिखें :-\
	`sudo dnf install sway`
*	pacman - आर्च लिनक्स (Arch Linux) बेस वाले लिनक्स डिस्ट्रो में निम्नानुसार कमांड को टर्मिनल मे लिखें :-\
  	`sudo pacman -S sway`
