...
static void handle_destroy(struct wl_listener *listener, void *data) {
	...
	wl_signal_emit(&sway_layer->events.destroy, sway_layer);
	wl_list_remove(&sway_layer->link);
...
static void subsurface_destroy(struct sway_layer_subsurface *subsurface) {
...
static struct sway_layer_subsurface *create_subsurface(
	...
	wl_signal_add(&layer_surface->events.destroy, &subsurface->surface_destroy);
...
void handle_layer_shell_surface(struct wl_listener *listener, void *data) {
	...
	wl_signal_init(&sway_layer->events.destroy);
